"""Regression checks for the packet-svc-router-gate casebook."""
...
from casebook.harness import assert_expected, packet_svc_router_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(packet_svc_router_gate_summary(), assert_expected())
